...
class TorchBlock(Trainer):
    ...
    def __post_init__(self) -> None:
        """Post init method for the TorchBlock class."""
    ...
    def save_model(self) -> None:
        ...
        logger.info(f"Saving model to tm/{self.prev_hash}.pt") if self.verbose else None
        torch.save(self.model, f"tm/{self.prev_hash}.pt")
        logger.info(f"Model saved to tm/{self.prev_hash}.pt") if self.verbose else None
